const message = function () {
    ...
    const description = {
        ...
        905: 'You will recive an email shortly with new password. When you do, use it to log in and go to: <span style="color: greenyellow">CONFIGURATION / PROFILE</span> to change it. <br><br><br><button>OK</button>',
        906: 'Please check currency and time zone',
        907: 'Loading...',
        908: 'Download failed, please contact administrator.',
        909: 'You have successfuly created a new operator. Taxes for new operator can be configured in <span style="color: greenyellow">ACCOUNTING / SETUP</span> tab. <br><br><br><button>OK</button>',
        1000: 'Successful!',
