const message = function () {
    ...
    const description = {
        ...
        905: 'You will receive an email shortly with new password. When you do, use it to log in and go to: <pre style="color: greenyellow">CONFIGURATION &#8250; PROFILE</pre> to change it. <br><br><button>OK</button>',
        906: 'Please check currency and time zone',
        907: 'Loading...',
        908: 'Download failed, please contact administrator.',
        909: 'You have successfully created a new operator. Taxes for new operator can be configured in <pre style="color: greenyellow">ACCOUNTING &#8250; SETUP</pre> tab. <br><br><button>OK</button>',
        ...
        2011: 'User is already logged in.',
